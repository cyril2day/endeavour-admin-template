  ...
  >
    <q-card-section>
      <div class="row justify-between">
        ...
        <q-chip color="blue-grey-2" icon="person_outline">{{
          role.slug
        }}</q-chip>
      </div>
    </q-card-section>
    ...
    <q-card-section>
      <q-form dense @submit.prevent @keyup.enter="update">
        ...
        <q-input v-model="user.phone_number" label="Phone" />
      </q-form>
    </q-card-section>
    ...
    <q-card-actions>
      ...
      <div class="q-ma-xs">
        <q-btn label="Update" type="submit" color="primary" @click="update" />
      </div>
    </q-card-actions>
  </q-card>
</template>
